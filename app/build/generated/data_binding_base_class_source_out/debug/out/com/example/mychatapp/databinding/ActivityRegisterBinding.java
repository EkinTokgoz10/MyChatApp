...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView6,
      @NonNull Button login, @NonNull EditText loginemail, @NonNull EditText loginpassword,
      @NonNull ProgressBar progressBar2, @NonNull Button signup, @NonNull TextView textView2,
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((ConstraintLayout) rootView, imageView6, login, loginemail,
          loginpassword, progressBar2, signup, textView2, textView3, textView4, textView5);
    }

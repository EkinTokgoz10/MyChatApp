...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView2,
      ...
      @NonNull ProgressBar progressBar, @NonNull Button signup, @NonNull TextView textView2,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, imageView2, login, loginemail,
          loginpassword, progressBar, signup, textView2, textView3, textView4, textView5);
    }
